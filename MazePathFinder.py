# -*- coding: utf-8 -*-
"""
Created on Sat Mar 12 09:08:46 2022

@author: 91927
"""

import pygame# Getting access to the pygame framework and imports all functions of pygame
import random#line no 119
import time#used for applying timer in game
from tkinter import *#to create main window of gui- here used to create instruction page of game
from PIL import Image, ImageTk#used to display instruction window in the form of image
from pygame import mixer#mixer is used for adding music to the game

instruction=Tk()#to display root window
instruction.geometry("930x733")#to provide dimensions of the window
photo=PhotoImage(file=r"C:\Users\91927\OneDrive\Pictures\instructionPage.png") #to access image of instruction page
instruct_page=Label(image=photo)#to label image
instruct_page.pack()#to pack the image-untill then we can't display it 
 
instruction.mainloop()#infinite loop used to run application as long as window is not closed


pygame.init()#used to initialize all the required module of the pygame.
# all fonts used-defining the fonts
...
pygame.display.set_caption('Maze_runner')#used to set the caption
...
class labyrinth:
    ...
    def __init__(self,id):
        ...
        # generates maze using uniform cost search algorithm
...
running = True
while running:
    mixer.music.load(r"C:\Users\91927\Downloads\BackgroundMusicForGame.mp3")
    ...
    while not done:
        ...
        if victory:
            ...
            reset = font3.render("Press Enter to go to Level:"+str(k),True,(255,255,255))
            ...
            diceDisplay = myFont.render(str(k), True,(255,255,255))
